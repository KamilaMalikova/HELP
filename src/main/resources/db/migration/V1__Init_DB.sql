...
create table product (id bigint not null, active_status bit not null, cost double precision not null, created_at datetime(6), in_stock_qty double precision not null, product_name varchar(255), restaurant bit not null, category integer, unit integer, primary key (id));
